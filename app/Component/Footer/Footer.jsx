...
export default function Footer() {
  return (
    <footer>
      ...
      <div className="bg-white py-10 mt-8 divide-x-2 divide-[#9F9F9F] ">
        <div className="  px-12 ">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-screen-lg ml-16 ">
            <div className="">
            ...
            <div>
              <h3 className="text-lg font-semibold text-[#9F9F9F] mb-12 ">
                Links
              </h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-[#9F9F9F] mb-8 ">
                Newsletter
              </h3>
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="py-2 border-b border-[#9F9F9F] outline-none "
                />
